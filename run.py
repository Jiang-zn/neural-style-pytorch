...
CONTENT_PATH = 'images/children.jpg'
STYLE_PATH = './images/1-style.jpg'
VGG19_PATH = './models/vgg19-d01eb7cb.pth'
VGG16_PATH = './models/vgg16-00b39a1b.pth'
ResNet18_PATH = './models/resnet18-f37072fd.pth'
ResNet34_PATH = './models/resnet34-b627a593.pth'
ResNet50_PATH = './models/resnet50-0676ba61.pth'
ResNet101_PATH = './models/resnet101-63fe2227.pth'
POOL = 'max'
...
# Save Image as out{num_iterms}.png，输出到当前目录的out文件夹下
def saveimg(img, iters):
    if (PIXEL_CLIP == 'True'):
        img = img.clip(0, 255)
    cv2.imwrite('out/out' + str(iters) + '.png', img)


# Color transfer,进行颜色转换的函数，其输入为两张图片，输出为将第一张图片的色调和第二张图片的色调相匹配的新图片
